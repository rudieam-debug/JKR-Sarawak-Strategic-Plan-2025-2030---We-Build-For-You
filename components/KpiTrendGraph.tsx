    ...
    <div ref={containerRef} className="w-full relative">
      ...
      <svg viewBox={`0 0 ${width} ${height}`} className={`w-full h-auto ${color}`}>
        ...
        <rect
            ...
            y={padding.top}
            width={graphWidth}
            height={Math.max(0, targetY - padding.top)}
        ...
        <g>
            ...
            />
             <text
                ...
                y={averageY}
                dy="0.3em"
                className="text-[9px] font-semibold fill-current text-gray-500 dark:text-slate-400"
            >
      ...
      <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-1 mt-3 text-xs text-gray-600 dark:text-slate-400">
        ...
        {trendData && (
         ...
         <div className="flex items-center space-x-1.5">
            <span className="w-4 border-t-2 border-dotted border-gray-500 dark:border-slate-400"></span>
            <span>Average</span>
        </div>
        <div className="flex items-center space-x-1.5">
